...
import ScannerJournalClient from './ScannerJournalClient';

export const dynamic = 'force-dynamic';

export default function ScannerJournalPage() {
  return (
          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-zinc-300">
                Watchlist of your trades — buy date and dollar amount. Paste chart screenshots with Ctrl+V (no file
                picker). Fill sell when done; P&amp;L auto-calculates.
              </p>
            </div>
