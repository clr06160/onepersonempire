    ...
    <main className="min-h-screen bg-zinc-950 px-6 py-10 text-zinc-100">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 rounded-3xl border border-zinc-800 bg-zinc-900/70 p-8 shadow-2xl">
          ...
          <h1 className="text-4xl font-bold tracking-tight">Proprietary Fundamentals</h1>
          <p className="mt-3 max-w-3xl text-zinc-300">
            Rule of 40, sales/EPS/FCF growth, gross-margin expansion, and proprietary earnings-reaction scores —
            unique signals most screeners miss — for the top-ranked names.
          </p>
        </div>
        <FmpScreenerClient />
      </div>
