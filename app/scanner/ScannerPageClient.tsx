          ...
          <section className="grid flex-1 items-center gap-10 py-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16 lg:py-16">
            ...
            <div className="lg:justify-self-end space-y-4">
              ...
              <div className="relative w-full max-w-sm overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] p-8 shadow-2xl backdrop-blur-xl">
                ...
                <p className="mt-2 text-sm leading-relaxed text-zinc-400">
                  Sign in with Google. After login you land on <span className="text-cyan-300">Leaders</span>.
                  <span className="text-lime-300"> Fun</span> (Forest / trees / art) is optional on the right.
                </p>
          ...
          {previewPolish ? (
            <div className="grid grid-cols-1 items-center gap-4 md:grid-cols-3">
              ...
              <div className="flex flex-wrap justify-center gap-2 md:justify-end">
                ...
                <Link
                  href="/scanner/fun"
                  className="rounded-full border border-lime-700 px-4 py-2 text-sm font-semibold text-lime-300 hover:border-lime-500 hover:text-lime-200"
                >
                  Fun
                </Link>
                {user ? (
