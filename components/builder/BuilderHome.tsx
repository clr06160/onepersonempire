...
import { InvoiceLinksPanel } from '@/components/builder/InvoiceLinksPanel';
...
First outreach message: ${businessPlan.firstOutreachMessage}`;
  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-white">
      ...
      <BuilderModals
        startOverConfirmOpen={startOverConfirmOpen}
        onCancelStartOver={() => setStartOverConfirmOpen(false)}
        onConfirmStartOver={startOverWithNewWebsite}
        couponModalOpen={couponModalOpen}
        couponDiscount={couponDiscount}
        setCouponDiscount={setCouponDiscount}
        couponDetails={couponDetails}
        setCouponDetails={setCouponDetails}
        onCloseCouponModal={() => setCouponModalOpen(false)}
        onCreateCoupon={createCouponSection}
        imageModalOpen={imageModalOpen}
        activeImage={activeImage}
        imageInstruction={imageInstruction}
        setImageInstruction={setImageInstruction}
        isGeneratingImage={isGeneratingImage}
        aiImageGenerationCount={aiImageGenerationCount}
        onCloseImageModal={() => setImageModalOpen(false)}
        onUploadImage={uploadActiveImage}
        onGenerateImage={generateActiveImage}
        modalOpen={modalOpen}
        ...
        venmoPaymentItem={venmoPaymentItem}
        setVenmoPaymentItem={setVenmoPaymentItem}
        venmoPaymentAmount={venmoPaymentAmount}
        setVenmoPaymentAmount={setVenmoPaymentAmount}
        ...
        activeDeletableSection={activeDeletableSection}
        setActiveDeletableSection={setActiveDeletableSection}
        isGenerating={isGenerating}
        aiCopyRewriteCount={aiCopyRewriteCount}
        onCloseTextModal={() => {
          setModalOpen(false);
          setActiveDeletableSection(null);
        }}
        onSaveText={handleManualSave}
        onAiSaveText={handleAISave}
        onDeleteAddedPage={deleteActiveAddedPage}
        onTestPaymentLink={testPaymentLink}
      />
      <FeedbackOverlays
        toasts={toasts}
